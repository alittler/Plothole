      ...
      <div className="flex-1 overflow-y-auto p-8">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 gap-4">
            {data.notes.map(note => (
              <div key={note.id} className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 group">
                ...
                <p className="text-slate-800 dark:text-slate-200 mb-4">{note.content}</p>
