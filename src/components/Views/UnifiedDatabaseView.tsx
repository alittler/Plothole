...
import { 
  ...
  ArrowUpDown, MoreHorizontal, X, Save, ChevronRight, Sparkles, Maximize2, Edit2, Globe, Shield, Ruler, Info, Link as LinkIcon
} from 'lucide-react';
...
const UNIVERSAL_FIELDS = [
  ...
  { key: 'sourceId', label: 'Source Entity ID', type: 'text', group: 'Identity' },
  { key: 'targetId', label: 'Target Entity ID', type: 'text', group: 'Identity' },
  { key: 'type', label: 'Classification', type: 'text', group: 'Identity' },
  { key: 'role', label: 'Narrative Role', type: 'text', group: 'Identity' },
  { key: 'description', label: 'Core Description', type: 'long', group: 'Content' },
  { key: 'history', label: 'Background/Origin', type: 'long', group: 'Content' },
  { key: 'status', label: 'State/Status', type: 'text', group: 'Status' },
  { key: 'livingStatus', label: 'Living Condition', type: 'text', group: 'Status' },
  { key: 'x', label: 'Spatial X', type: 'number', group: 'Spatial' },
  { key: 'y', label: 'Spatial Y', type: 'number', group: 'Spatial' },
  { key: 'mapId', label: 'Map Owner ID', type: 'text', group: 'Spatial' },
  { key: 'shortId', label: 'Technical ID', type: 'text', group: 'Spatial' },
  { key: 'plusCode', label: 'Plus Code', type: 'text', group: 'Spatial' },
  { key: 'date', label: 'Temporal Date', type: 'text', group: 'Temporal' },
  { key: 'uei', label: 'Universal Index', type: 'number', group: 'Temporal' },
